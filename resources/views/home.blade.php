        ...
        <div class="flex flex-col gap-12  md:mt-8 w-[340px] md:w-full mx-auto container">
            <div x-data="{ open: false }"
                ...
                <div @click="open = !open" class="flex flex-col items-center cursor-pointer w-full">
                    <span class="text-[#AFD5AA] font-[Blinker] mb-3 text-center uppercase font-semibold text-4xl md:text-5xl max-w-[260px] pointer-events-none">
                        Links utiles
                    </span>
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/lucas-daniel-bell/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64px" height="64px" viewBox="0 0 24 24">
                                ...
                                <g fill="none" stroke="#AFD5AA" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
            ...
            <div x-data="{ open: false }"
                ...
                <div x-show="open" x-cloak x-collapse x-transition class="grid grid-cols-2 md:grid-cols-3 container gap-6 pt-6 justify-items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="64px" height="64px" viewBox="0 0 24 24">
                        <title>html</title>
                        <g fill="none" stroke="#6D665F" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="64px" height="64px" viewBox="0 0 24 24">
                        <title>python</title>
                        <g fill="none">
                            <path stroke="#6D665F" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 7.5H7.5m4.5 9h4.5m0 0h1.521c.807 0 1.634-.188 2.13-.824c.531-.679 1.099-1.835 1.099-3.676c0-1.84-.568-2.997-1.098-3.676c-.497-.636-1.324-.824-2.13-.824H16.5m0 9v1.521c0 .807-.188 1.634-.824 2.13c-.679.531-1.835 1.099-3.676 1.099-1.84 0-2.997-.568-3.676-1.098c-.636-.497-.824-1.324-.824-2.13V16.5m0-9H5.978c-.807 0-1.633.188-2.13.824-.53.679-1.098 1.835-1.098 3.676c0 1.84.568 2.997 1.098 3.676c.497.636 1.323.824 2.13.824H7.5m0-9V5.978c0-.807.188-1.633.824-2.13c.679-.53 1.835-1.098 3.676-1.098c1.84 0 2.997.568 3.676 1.098c.636.497.824 1.323.824 2.13V7.5m-9 9V14a2 2 0 0 1 2-2h5a2 2 0 0 0 2-2V7.5" />
