...
<div class="flex  justify-between items-center py-12 ">
    ...
    <div class="flex flex-col gap-10  ">
        ...
        <h1 class="font-[Blinker] mx-30 text-[#6D665F] text-8xl font-bold max-w-[600px] tracking-[0.13em] leading-tight relative ">FRONT-END DEVELOPER</h1>

        <div class="flex flex-col max-w-[700px] mx-auto items-center gap-5">
            <p class="font-[Blinker] text-7xl font-italic tracking-wider text-[#8C6057] text-center">SOBRE MI</p>
            <div class="flex px-5 py-5 bg-[#8C6057]/90 rounded-4xl ">
                <p class="text-[#F0F2EF] text-lg leading-10 py-5">
                    Me llamo Lucas Bell, tengo 21 años. Siempre desde chico me atrae la computación, siendo a mis 17 mis primeras cercanias a la programación. Luego, a partir de descubrir este mundo, a lo largo de los años hice unos cursos y me fui acercando de a poco más a este sector hasta el día de hoy. Ofrezco soluciones y mantenimientos a páginas webs. 
                </p>
            </div>  
        </div>
    </div>
